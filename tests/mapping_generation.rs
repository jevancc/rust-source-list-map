...
mod mapping_generation {
    ...
    fn should_generate_mappings() {
        ...
        map.add(g_NStr("Gen\nCode "), g_Str(""), g_Str(""));
		map.add(g_NStr("Source\nCode\n"), g_Str("file.txt"), g_Str("Source\nCode\n"));
		map.add(g_NStr("Gen "), g_Str(""), g_Str(""));
		map.add(g_NStr("Code "), g_Str(""), g_Str(""));
		map.add(g_NStr("Source\nCode"), g_Str("file.txt"), g_Str("Source\nCode\n"));
    ...
    fn should_the_same_mappings_for_single_line_and_normal_node() {
        let mut map1 = SourceListMap::new(None, "", "");
        let mut map2 = SourceListMap::new(None, "", "");

		map1.add(
                Node::NSingleLineNode(SingleLineNode::new(g_Str("abc"), g_Str("abc"), g_Str("source"), 10)),
                g_Str(""),
                g_Str(""))
            .add(g_NStr("\n\n"), g_Str(""), g_Str(""))
        ...
        map2.add(
                Node::NSourceNode(SourceNode::new(g_Str("abc"), g_Str("abc"), g_Str("source"), 10)),
                g_Str(""),
                g_Str(""))
            .add(g_NStr("\n\n"), g_Str(""), g_Str(""))
            .add(g_NStr("Source Code\n"), g_Str("file.txt"), g_Str("Source\nCode\n"));
